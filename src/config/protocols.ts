...
export const protocols: IProtocolDefinitionMap = {
  ...
  kyberswap: {
    identifier: "kyberswap",
    name: "Kyberswap",
    twitter: "https://x.com/KyberNetwork",
    logo: "https://storage-mercle-prod.s3.amazonaws.com/public/protocol-logos/kyberswap.png",
  ...
  orbiter: {
    ...
    logo: "https://storage-mercle-prod.s3.amazonaws.com/public/protocol-logos/orbiter.png",
    website: "https://www.orbiter.finance/en",
    type: ProtocolType.DEX_AGGREGGATOR,
    actionTags: [ActionTags.SWAP],
  },
  allBridge: {
