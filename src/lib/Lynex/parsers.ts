...
enum CONTRACT_FUNCTION_NAMES {
  ...
  SWAP_EXACT_TOKENS_FOR_TOKENS_SIMPLE = "swapExactTokensForTokensSimple",
  UNSAFE_SWAP_EXACT_TOKENS_FOR_TOKENS = "UNSAFE_swapExactTokensForTokens"
}

export class LynexParser {
  ...
  public static async parseLynexRouterTransaction(
    ...
    switch (parsedTxn.name) {
      ...
      case CONTRACT_FUNCTION_NAMES.SWAP_EXACT_TOKENS_FOR_TOKENS || CONTRACT_FUNCTION_NAMES.SWAP_EXACT_TOKENS_FOR_TOKENS_SIMPLE:
        actions.push(
  ...
  private static getTokenTransfersFromCallData(
    ...
    const toToken = parsedTxn.args.routes[parsedTxn.args.routes.length - 1].to;
