...
export const lifiData: IProtocolTestingData = {
  [LIFI_VERSIONS.V1]: [
    ...
    {
        txnHash: '0xeeee6db16353d51705ebde331f58f976ac055f761e70e8326eedbec50ee86eeb',
        chainId: CHAIN_ID.ARBITRUM,
        emittedActions: [
          {
            type: ACTION_ENUM.SINGLE_SWAP,
            ...
            fromAmount: '115792089237316195423570985008687907853269984665640564039457564057528224148974',
            toAmount: '62499427',
    ...
    {
      txnHash: '0xe7c5e86cc025ad1d91c187d26f285f99bb630d936d9a5036df7cbc4a10d59ee9',
      chainId: CHAIN_ID.ARBITRUM,
      emittedActions: [
        {
          type: ACTION_ENUM.BRIDGE_OUT,
    ...
    {
        txnHash: '0xc9471f2d81af80a82a2604a3997d3115bcf9ffc418503580da0da7c7c94376c8',
        chainId: CHAIN_ID.ARBITRUM,
        emittedActions: [
          {
            type: ACTION_ENUM.BRIDGE_OUT,
      ...
      {
        txnHash: '0xdcda0af37c77c4159382e698cdc77e9522b7fadcd5df47a214e360646440c3d9',
        chainId: CHAIN_ID.ARBITRUM,
        emittedActions: [
          {
            type: ACTION_ENUM.BRIDGE_OUT,
      ...
      {
        txnHash: '0x8d4ecba9f39324dff431d56231654077fbeed47133ce98ffe3ee5bc5b19dd49b',
        chainId: CHAIN_ID.ARBITRUM,
        emittedActions: [
          {
            type: ACTION_ENUM.SINGLE_SWAP,
            ...
            toAmount: '115792089237316195423570985008687907853269984665640564039457584007912772592150',
